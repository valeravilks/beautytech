<?php if(get_field('product-content-testimonials-title')): ?>

<?php get_template_part('template-parts/h2-block', '', array(
			'h2' => get_field('product-content-testimonials-title'),
		));
?>
    ...
    <div class="container">
      <div class="swiper home-rev__slider">
        <div class="swiper-wrapper">
          <?php if(have_rows('product-content-testimonials-list')) :
              while(have_rows('product-content-testimonials-list')) : the_row(); ?>
